          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b demo-divider">
                ...
                <th className="text-left demo-text py-2 px-3">RWI High</th>
                <th className="text-left demo-text py-2 px-3">RWI Low</th>
            ...
            <tbody>
              {sampleValues.map(row => (
                <tr key={row.period} className="border-b demo-divider">
                  ...
                  <td className="demo-text font-mono py-2 px-3">{row.high}</td>
                  <td className="demo-text font-mono py-2 px-3">{row.low}</td>
