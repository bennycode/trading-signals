          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b demo-divider">
                ...
                <th className="text-left demo-text py-2 px-3">Bull Power</th>
                <th className="text-left demo-text py-2 px-3">Bear Power</th>
            ...
            <tbody>
              {sampleValues.map(row => (
                <tr key={row.period} className="border-b demo-divider">
                  ...
                  <td className="demo-text font-mono py-2 px-3">{row.bull}</td>
                  <td className="demo-text font-mono py-2 px-3">{row.bear}</td>
