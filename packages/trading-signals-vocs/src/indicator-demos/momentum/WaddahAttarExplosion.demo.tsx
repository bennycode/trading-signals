          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b demo-divider">
                ...
                <th className="text-left demo-text py-2 px-3">Trend</th>
                <th className="text-left demo-text py-2 px-3">Explosion</th>
                <th className="text-left demo-text py-2 px-3">Dead Zone</th>
            ...
            <tbody>
              {sampleValues.map(row => (
                <tr key={row.period} className="border-b demo-divider">
                  ...
                  <td className="demo-text font-mono py-2 px-3">{row.trend}</td>
                  <td className="demo-text font-mono py-2 px-3">{row.explosion}</td>
                  <td className="demo-text font-mono py-2 px-3">{row.deadZone}</td>
