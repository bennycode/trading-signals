...
const indicators: IndicatorConfig[] = [
  ...
  },
  {
    ...
    requiredInputs: 5,
    details:
      'Momentum measures the change in price from n periods ago. Signals are evaluated every n periods: BULLISH when momentum increases, BEARISH when momentum decreases.',
