...
function PerformanceCards({candles, result}: ResultProps) {
  ...
  const cards = [
    ...
    {
      info: 'Largest peak-to-trough drop in portfolio value. The worst loss you would have sat through — lower is better.',
      label: 'Max Drawdown',
      positive: null,
      value: `${formatBig(performance.maxDrawdownPercentage)}%`,
    },
    {
