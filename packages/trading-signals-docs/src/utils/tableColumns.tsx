...
const priceColumns: Record<PriceColumnKey, ColumnDef> = {
  close: {className: 'demo-text py-2 px-3', header: 'Close', key: 'close', render: formatUsd},
  high: {className: 'demo-text py-2 px-3', header: 'High', key: 'high', render: formatUsd},
  low: {className: 'demo-text py-2 px-3', header: 'Low', key: 'low', render: formatUsd},
  open: {className: 'demo-text py-2 px-3', header: 'Open', key: 'open', render: formatUsd},
  volume: {className: 'demo-text py-2 px-3', header: 'Volume', key: 'volume'},
};
...
export function buildTableColumns({extra = [], indicator, inputs}: BuildOptions): ColumnDef[] {
  const cols: ColumnDef[] = [
    ...
    {className: 'demo-text font-mono py-2 px-3', header: 'Result', key: 'result'},
    ...extra,
  ];
