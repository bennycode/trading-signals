...
| [**@typedtrader/messaging**](./packages/messaging) | Messaging interface for controlling personal trading bots remotely via [XMTP](https://xmtp.org/) (end-to-end encrypted) and [Telegram](https://core.telegram.org/bots). Both platforms can run simultaneously. |
